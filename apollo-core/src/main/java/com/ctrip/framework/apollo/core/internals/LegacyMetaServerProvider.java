...
public class LegacyMetaServerProvider implements MetaServerProvider {
  ...
  private void initialize() {
    ...
    domains.put(Env.PCITCDEV, getMetaServerAddress(prop, "pcitcdev_meta", "pcitcdev.meta"));
    domains.put(Env.PCITCTEST, getMetaServerAddress(prop, "pcitctest_meta", "pcitctest.meta"));
    domains.put(Env.PCITCPRO, getMetaServerAddress(prop, "pcitcpro_meta", "pcitcpro.meta"));
  }
